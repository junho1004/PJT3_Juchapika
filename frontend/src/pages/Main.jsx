...
export default function Main() {
  ...
  useEffect(() => {
    ...
    // axios로 폼 데이터 전송
    axios
      .post("https://52.79.199.205:8081/api/record/search-by-detail", data)
      .then((res) => {
  ...
  const convertExcel = () => {
    ...
    axios
      .post("https://52.79.199.205:8081/api/record/download", data, {
  ...
  const openstatistic = () => {
    ...
    axios
      .post("https://52.79.199.205:8081/api/record/statistics", data)
      .then((res) => {
        console.log("12345");
        console.log(res.data.responseData[0]);
